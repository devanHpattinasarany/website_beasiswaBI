...
<head>
    ...
    <title>BeasiswaBI &mdash; Registrasi</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label fontroboto">Email</label>
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <a class="text-primary fw-bold ms-2" href="./authentication-register.html">Masuk</a>
                                    </div>
                                </form>
                            </div>
                        </div>
